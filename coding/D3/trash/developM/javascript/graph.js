...
d3.json("./json/mydata.json", function(error, data){
    ...
    barElements1 = d3.select("#myGraph1")
                     .selectAll("rect")
                     .data(dataSet);
    ...
    barElements1.enter()
            ...
            .attr("x", function(d ,i){
                return i*(barWidth + barMargin) + offsetX + barWidth*2; //調整要(データ追加時のx座標参照)
            })
            .attr("y", function(d, i){
